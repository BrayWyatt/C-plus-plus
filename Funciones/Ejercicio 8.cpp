/* Ejercicio 8: Escribe una función nombrada cambio() que tenga un parámetro en número entero y seis
parámetros de referencia en un número entero nombrados cien, cincuenta, veinte, diez, cinco y uno
respectivamente. La función tiene que considerar el valor entero transmitido como una cantidad
en dolares y convertir el valor en el número menor de billetes equivalentes */
